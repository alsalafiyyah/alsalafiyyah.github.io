...
summary: Smiling does not invalidate Salah but laughing with sound does. Also, if
  a person deliberately talks during Salah while knowing that doing so is Haram (prohibited),
  the Salah is invalidated.
muftis:
  shaykh:
