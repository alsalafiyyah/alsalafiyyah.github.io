...
summary: No! They are not sinners. They should only encourage thern to perform it.
  However, when children reach ten years old, it is Wajib (obligatory) to command
  them to offer Salah and admonish them lightly if they are negligent until they comply.
muftis:
  shaykh:
