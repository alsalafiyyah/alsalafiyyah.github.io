...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-8 py-4 max-w-7xl mx-auto">
    ...
    <div class="group flex flex-col border-2 border-black dark:border-white dark:bg-zinc-950 transition-all hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
