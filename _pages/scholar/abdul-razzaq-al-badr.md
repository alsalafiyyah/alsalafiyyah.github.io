...
official_web: https://www.al-badr.net/
bio_url: /biography/abdul-razzaq-al-badr/
permalink: /scholar/abdul-razzaq-al-badr/
---

{% assign ulama_posts = site.posts | where_exp:"item", "item.path contains '_posts/abdul-razzaq-al-badr/'" %}
