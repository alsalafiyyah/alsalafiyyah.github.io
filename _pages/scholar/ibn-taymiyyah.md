...
official_web: https://index.taimiah.org/
bio_url: /biography/ibn-taymiyyah/
permalink: /scholar/ibn-taymiyyah/
---

{% assign ulama_posts = site.posts | where_exp:"item", "item.path contains '_posts/ibn-taymiyyah/'" %}
