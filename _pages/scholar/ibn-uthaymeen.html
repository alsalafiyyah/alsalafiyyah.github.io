...
official_web: https://binothaimeen.net/
bio_url: /biography/uthaymeen/
permalink: /scholar/ibn-uthaymeen/
---

{% assign ulama_posts = site.posts | where_exp:"item", "item.path contains '_posts/ibn-uthaymeen/'" %}
