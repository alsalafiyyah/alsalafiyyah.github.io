---
layout: page
title: "Shaykh Abdul Rahman Nasir al-Sa'di"
official_web: https://ibn-saadi.com/
bio_url: /biography/saadi/
permalink: /scholar/saadi/
---

{% assign ulama_posts = site.posts | where_exp:"item", "item.path contains '_posts/saadi/'" %}
