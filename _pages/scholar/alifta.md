---
layout: page
title: "Permanent Committee for Scholarly Research and Ifta"
official_web: https://alifta.gov.sa/
bio_url: /biography/alifta/
permalink: /scholar/alifta/
---

{% assign alifta_posts = site.posts | where_exp:"item", "item.path contains '_posts/alifta/'" %}
...
<header class="pb-8 md:pb-8 border-b-4 border-black dark:border-white">
  <div class="max-w-7xl">
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
      ...
      <!-- Actions & Metadata Block (4 Columns) -->
      <div class="md:col-span-4 flex flex-col sm:flex-row md:flex-col items-start sm:items-center md:items-end justify-between md:justify-end gap-4">
        ...
        <p class="text-xs md:text-sm font-black uppercase tracking-widest px-3 py-1 bg-black text-white dark:bg-white dark:text-black">
          Total Entries: {{ alifta_posts.size }}
        </p>
        {% endif %}
...
[
  {% for post in site.posts %}
   {% if post.path contains "_posts/alifta/" %}
    {
