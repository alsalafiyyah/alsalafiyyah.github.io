...
official_web: https://www.muqbel.net/
bio_url: /biography/muqbil/
permalink: /scholar/muqbil-ibn-hadi/
---

{% assign ulama_posts = site.posts | where_exp:"item", "item.path contains '_posts/muqbil-ibn-hadi/'" %}
