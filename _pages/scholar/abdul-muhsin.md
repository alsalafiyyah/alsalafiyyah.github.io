...
bio_url: /biography/abdulmuhsin-alabbad/
permalink: /scholar/abdul-muhsin/
---

{% assign ulama_posts = site.posts | where_exp:"item", "item.path contains '_posts/abdul-muhsin/'" %}
