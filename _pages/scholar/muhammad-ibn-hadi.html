...
bio_url: /biography/muhammad-ibn-hadi/
permalink: /scholar/muhammad-ibn-hadi/
---

{% assign ulama_posts = site.posts | where_exp:"item", "item.path contains '_posts/muhammad-ibn-hadi/'" %}
